...
public class App {
        ...
        while (!salir) {
            ...
            switch (opcion) {
                ...
                case 5:
                    ...
                    break;
                case 6:
                    System.out.println("Lamentamos informarle que, debido a circunstancias imprevistas, no fue posible atender la emergencia en el momento requerido. Entendemos la importancia de la situación y estamos tomando las medidas necesarias para evitar que esto vuelva a ocurrir. Agradecemos su comprensión y quedamos atentos para brindarle el apoyo necesario");
                    break;
                case 7:
                    salir = true;
    ...
    private static void mostrarMenu() {
        ...
        System.out.println("6. no se pudo atender esta emergencia");
